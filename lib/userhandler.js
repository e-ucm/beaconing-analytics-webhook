...
module.exports = (function () {
    ...
    /**
     * Creates a user into A2 with an Beaconing email and its
     ...
     * @param  {object}   classe   The group object from Beaconing Core
    ...
    /**
     * Deletes a group with a Beaconing group ID as the one given.
     * @param  {string}   id       The External Beaconing ID of the group to be deleted
   ...
   /**
    * Receives a list of Beaconing External IDs of participants and adds them to a class
    ...
    */
    ...
    /**
     * Receives a list of Beaconing External IDs of participants and removes them from a class
     * @param  {object}   classe   Object that contains 2 optional sublists of students and teachers
     * @param  {string}   teacher  Username of the teacher who owns the group
     * @param  {object}   config   Configuration of the webhook
     * @param  {Function} callback Callback function to be called when everything is completed
    ...
    /**
     * Transforms a list of Beaconing IDs into a list of Backend usernames of the students
     ...
     * @param  {string}   id           Beaconing External ID of the class.
    ...
    userHandler.removeParticipants = function(id, participants, teacher, config, callback){
        ...
        request({
            uri: config.backendUrl + 'api/classes/external/beaconing/' + id + '/remove',
            method: 'PUT',
            body: {
                participants: participants
            },
    ...
    /**
     * Obtains the class object from an external Beaconing ID of the group
     * @param  {string}   id       Beaconing External ID of the class
     * @param  {string}   teacher  Username of the teacher who owns the class
     * @param  {object}   config   Configuration of the webhook
     * @param  {Function} callback Callback function to be called when everything is completed
    ...
    /**
     * Obtains the user object from an external Beaconing ID of the user
     * @param  {string}   id       Beaconing External ID of the user
     * @param  {object}   config   Configuration of the webhook
     * @param  {Function} callback Callback function to be called when everything is completed
