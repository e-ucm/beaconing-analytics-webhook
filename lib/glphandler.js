...
module.exports = (function () {
    ...
    glpHandler.assigned = function(glp, classId, teacher, config, esClient, callback){
                        ...
                        if(error){
                            ...
                            for (var id in nodes) {
                                ...
                                glpHandler.createActivity(content.id + '_' + id + '_(' + nodes[id].name + ')', gameId,
                                    versionId, classe._id, teacher, result._id, nodes[id], config, 
                                    function(error, result){
                                        if(error){
                                            return callback(error);
                                        }else{
