...
module.exports = (function () {
    ...
    glpHandler.insertStructure = function(rootId, activityId, body, esClient, callback){
        ...
        body.limits.partialTresholds = body.limits.partialTreshold;
        body.limits.fullTresholds = body.limits.fullTreshold;

        delete body.limits.partialTreshold;
        delete body.limits.fullTreshold;
