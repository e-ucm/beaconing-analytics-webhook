...
module.exports = (function () {
    ...
    glpHandler.createTreeInElastic = function(glp, total, esClient, callback){
		...
		for(var i in glp.missions){
			...
			for(var j in glp.missions[i].quests){
				...
				for(var k in glp.missions[i].quests[j].graph.quest.challenges){
					...
					for(var l in glp.missions[i].quests[j].graph.quest.challenges[k].activities){
						...
						glpHandler.insertStructure(rootId, glp.missions[i].quests[j].analytics.activityId, esClient,
						{
				...
				glpHandler.insertStructure(rootId, content.missions[i].quests[j].analytics.activityId, esClient,
				{
			...
			glpHandler.insertStructure(rootId, current_mission.analytics.activityId, esClient,
			{
		...
		glpHandler.insertStructure(rootId, glp.analytics.activityId, esClient,
		{
